...
if(s.equals("STOP"))return 00;
if(s.equals("ADD"))return 01;
if(s.equals("SUB"))return 2;
if(s.equals("MULT"))return 3;
if(s.equals("MOVER"))return 4;
if(s.equals("MOVEM"))return 5;
if(s.equals("COMP"))return 6;
if(s.equals("BC"))return 7;
if(s.equals("DIV"))return 8;
if(s.equals("READ"))return 9;
if(s.equals("PRINT"))return 10;
if(s.equals("START"))return 01;
if(s.equals("END"))return 2;
if(s.equals("ORIGIN"))return 3;
if(s.equals("EQU"))return 4;
if(s.equals("LTORG"))return 5;
if(s.equals("DC"))return 1;
if(s.equals("DS"))return 2;
return -1;
}
static String opclass(String s) {
if(s.equals("ADD")||s.equals("STOP")||s.equals("SUB")||s.equals("MULT")||
s.equals("MOVER")||s.equals("MOVEM")||s.equals("COMP")||s.equals("BC")||
s.equals("DIV")||s.equals("READ")||s.equals("PRINT"))return "IS";
if(s.equals("START")||s.equals("END")||s.equals("ORIGIN")||s.equals("EQU")||
s.equals("LTORG"))return "AD";
if(s.equals("DS")||s.equals("DC"))return "DL";
return "$";
}
static int registers(String s)
{ if(s.equals("AREG"))return 1;
if(s.equals("BREG")) return 2;
if(s.equals("CREG"))return 3;
if(s.equals("DREG")) return 4;
return -1;
} static int condition_codes(String s)
{ if(s.equals("LT"))return 1;
if(s.equals("LE")) return 2;
if(s.equals("EQ"))return 3;
if(s.equals("GT")) return 4;
if(s.equals("GE")) return 5;
if(s.equals("ANY")) return 6;
return -1;
}
...
{ symbtab.put(a[0], lc);
op=a[1];
if(a.length>2)op1=a[2];
if(a.length>3)op2=a[3];
} else
{ op=a[0];
if(a.length>1)op1=a[1];
if(a.length>2)op2=a[2];
} opco=opcode(op);
String opclass=opclass(op);
//Printing opcode
if(!op.equals("EQU") && !op.equals("LTORG") )
myObj.write("("+opclass+","+opco+") ");
if(op.equals("MOVER" )||op.equals("MOVEM") || op.equals("ADD") || op.equals("SUB")
|| op.equals("MULT")|| op.equals("DIV")|| op.equals("COMP"))
{ int r=registers(op1);
myObj.write(" ("+r+") ");
int s;
if(op2.charAt(0)=='=')
...
List<String> listKeys = new ArrayList<String>( keys );
s=listKeys.indexOf(op2)+1; myObj.write(" (S,"+s+") ");
} else
{ symbtab.put(op2,0);
s=symbtab.size();
myObj.write(" (S,"+s+") ");
...
int check=0;
if(op.equals("EQU"))check=1;
if(op.equals("LTORG") || op.equals("END"))
{ if(op.equals("END"))myObj.write("\n");
